...
const char * const BITCOIN_CONF_FILENAME = "chancoin.conf";
const char * const BITCOIN_PID_FILENAME = "chancoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Chancoin";
#else
    // Unix
