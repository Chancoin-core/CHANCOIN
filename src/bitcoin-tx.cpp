...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s chancoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  chancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chancoin transaction") + "\n" +
              "  chancoin-tx [options] -create [commands]   " + _("Create hex-encoded chancoin transaction") + "\n" +
              "\n";
