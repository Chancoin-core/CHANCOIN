...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/chancoin-project/chancoin>";
    const std::string URL_WEBSITE = "<https://chancoin.org>";
