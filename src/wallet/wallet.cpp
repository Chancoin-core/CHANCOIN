...
{
  if ( 
      (tx.get()->GetHash() == uint256S("cbf8b1b17674be6eebd3934e73b50dbf273fa4ff32cefe6d380aa2ecf378d55b")) || // Test freeze
      (tx.get()->GetHash() == uint256S("39faccc8532f80050f55d19bd5be3d57865e4814055295c25a7e5b142585c166")) || // 853737.95200000 CHAN burned
      (tx.get()->GetHash() == uint256S("39faccc8532f80050f55d19bd5be3d57865e4814055295c25a7e5b142585c166")) || // 223982.00000000 CHAN burned
      (tx.get()->GetHash() == uint256S("5776c25bf287796e0e9f16c3fb1267784c9516768bbfcdf058b4f58224da52bb")) || // 198223.00000000 CHAN burned
      (tx.get()->GetHash() == uint256S("71a6dff81e73702a88c425288862177288f6a9d80a172efa500de1d34e851134")) || // 200000.00000000 CHAN burned
      (tx.get()->GetHash() == uint256S("ec84978a9ff4bd46921627a9f547965078612346cfbd37fa3f40f325c2c5f372")) || // 100000.00000000 CHAN burned
      (tx.get()->GetHash() == uint256S("b733116214778e49bf37ebc268b5e4118516b1b70d3e7327b77ef66fb26b4917")) || // 100000.00000000 CHAN burned
      (tx.get()->GetHash() == uint256S("3a4c828cbf4413c25333dd705f9be5f9e245e746496eee2b697e4acebe3091f2")) || // 276907.82489380 CHAN burned
      (tx.get()->GetHash() == uint256S("a50f178673431d12435734d104c8c5772b32eac3adc7d9b49e9664765ce22458")) || // 99732.43636414 CHAN burned
      (tx.get()->GetHash() == uint256S("f8cb03e0238d5c307c87624f23c5fcef1793391a03dd936069fb0943ee8ad03a")) || // 99719.88346663 CHAN burned
      (tx.get()->GetHash() == uint256S("982c8f54afab90b5163a7c7e845c05309427ea020a78afc635fe168e9759e9d5"))) { // 99999.00000000 CHAN burned
    LogPrintf("ERROR: IsTrusted: burnt coins from txid %s cannot be trusted!\n", tx.get()->GetHash().ToString().c_str());
    return false;
  }
